...
import { 
  ...
  MapPin, CreditCard, Calendar, Building, AlertCircle
} from 'lucide-react'
...
export default function NewTenantPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.error?.message || 'Failed to create tenant account')
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="min-h-screen bg-background-light">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="card">
          <h1 className="text-3xl font-heading font-bold mb-6">Add New Tenant</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {currentStep === 4 && (
              <div className="space-y-4">
                ...
                <div className="bg-primary-light/30 border border-primary/20 rounded-medium p-4">
                  <p className="text-sm text-text-secondary">
                    <strong>Note:</strong> The tenant will receive login credentials and can access their account. 
                    You can manage all tenants from the tenants list.
                  </p>
                </div>
              </div>
            )}
