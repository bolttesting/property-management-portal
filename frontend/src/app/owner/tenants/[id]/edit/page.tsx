...
import { 
  ArrowLeft, User, Mail, Phone, Lock, Globe, Briefcase, Upload, X, FileText,
  MapPin, CreditCard, Calendar, Building, AlertCircle, Save
} from 'lucide-react'
...
export default function EditTenantPage() {
  ...
  const loadTenant = async () => {
    ...
    try {
      ...
      console.log('Loading tenant for edit with ID:', tenantId, 'Type:', typeof tenantId)
      ...
      console.log('Tenant data loaded:', tenant.id, tenant.full_name)

      // Parse current_address if it's a string
      let currentAddress = tenant.current_address || {}
      ...
      setFormData({
        ...
        passportNumber: tenant.passport_number || '',
        passportExpiry: '',
        visaNumber: tenant.visa_number || '',
        visaExpiry: '',
        visaType: '',
        ...
        workPhone: '',
        currentAddress: {
          emirate: currentAddress.emirate || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await ownerAPI.updateTenant(params.id as string, {
      ...
      toast.error(error.response?.data?.error?.message || 'Failed to update tenant account')
    } finally {
      setSaving(false)
    }
  }
  ...
  return (
    <div className="min-h-screen bg-background-light">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="card">
          <h1 className="text-3xl font-heading font-bold mb-6">Edit Tenant Account</h1>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      <Globe className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-text-tertiary" />
                      <select
